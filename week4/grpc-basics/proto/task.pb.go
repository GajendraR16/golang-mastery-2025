...
type ListTasksResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tasks         []*Task                `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty"` // repeated = slice
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_task_proto_rawDesc = "" +
	...
	"\fCompleteTask\x12\x19.task.CompleteTaskRequest\x1a\x1a.task.CompleteTaskResponseB\x13Z\x11grpc-basics/protob\x06proto3"
...
var file_proto_task_proto_goTypes = []any{
	...
	(*CompleteTaskResponse)(nil), // 8: task.CompleteTaskResponse
}
var file_proto_task_proto_depIdxs = []int32{
	...
	0, // 3: task.CompleteTaskResponse.task:type_name -> task.Task
	...
	7, // 7: task.TaskService.CompleteTask:input_type -> task.CompleteTaskRequest
	...
	6, // 10: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
	8, // 11: task.TaskService.CompleteTask:output_type -> task.CompleteTaskResponse
