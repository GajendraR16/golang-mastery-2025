...
const file_proto_task_proto_rawDesc = "" +
	"\n" +
	"\x10proto/task.proto\x12\x04task\"u\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\x0fListTaskRequest\"4\n" +
	"\x10ListTaskResponse\x12 \n" +
	"\x05tasks\x18\x01 \x03(\v2\n" +
	".task.TaskR\x05tasks2\xc1\x01\n" +
	"\vTaskService\x12?\n" +
	"\n" +
	...
	"\bListTask\x12\x15.task.ListTaskRequest\x1a\x16.task.ListTaskResponseB\x13Z\x11grpc-basics/protob\x06proto3"
...
var file_proto_task_proto_goTypes = []any{
	...
	(*ListTaskResponse)(nil),   // 6: task.ListTaskResponse
}
var file_proto_task_proto_depIdxs = []int32{
	...
	5, // 5: task.TaskService.ListTask:input_type -> task.ListTaskRequest
	...
	6, // 8: task.TaskService.ListTask:output_type -> task.ListTaskResponse
